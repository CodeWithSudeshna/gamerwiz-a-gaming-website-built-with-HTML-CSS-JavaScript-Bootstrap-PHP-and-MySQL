                ...
                <div class="collapse navbar-collapse menubar ps-5" id="navbarSupportedContent">
                    <ul class="navbar-nav mb-2 m-auto mb-lg-0">
                        ...
                        <li class="nav-item pe-3 dropdown">
                            <a class="nav-link dropdown-toggle <?php echo ($currentPage == 'about.php') ? 'active' : ''; ?>" href="#" id="dropdownAbout" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ABOUT & REVIEW
                            </a>
                            <ul class="dropdown-menu bg-dark" aria-labelledby="dropdownAbout">
                                <li><a class="dropdown-item  <?php echo ($currentPage == 'about.php') ? 'active' : ''; ?>" href="about.php">ABOUT</a></li>
                                <li><a class="dropdown-item <?php echo ($currentPage == 'index.php#review') ? 'active' : ''; ?>" href="index.php#review">REVIEWS</a></li>
                            </ul>
                        </li>

                        <!-- Second dropdown -->
                        <li class="nav-item pe-3 dropdown">
                            <a class="nav-link dropdown-toggle <?php echo ($currentPage == 'games.php') ? 'active' : ''; ?>" href="#" id="navbarDropdown2" role="button" data-bs-toggle="dropdown" aria-expanded="false"> EVENTS & REWARDS </a>
                            <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown2">
                                <li><a class="dropdown-item menubar <?php echo ($currentPage == 'games.php') ? 'active' : ''; ?>" href="games.php">GAMES</a></li>
                                <li><a class="dropdown-item menubar <?php echo ($currentPage == 'ndex.php#tournament') ? 'active' : ''; ?>" href="index.php#tournament">TOURNAMENTS</a></li>
